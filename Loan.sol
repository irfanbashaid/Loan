...
contract Loan
{
    ...
    function update_loan(uint256 _loan_id, uint256 _amount) public payable returns(bool)
    {
        require(issuer == msg.sender);
    ...
    mapping(uint256 => mapping(uint256 => bool)) public is_owned_investor; //spv_ids,_pool_id
